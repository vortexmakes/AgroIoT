...
#define TPLINK_SLAVE_ADDRESS	0x0B				/* Device Address [0x01 .. 0x7F] */

#define TPLINK_SOF				0xF1				/* Start of Frame "MARK" */
#define TPLINK_ESC				0xF2				/* Escape character */

#define TPLINK_MAX_PLOAD_SIZE	128					/* Max Payload Size */

#define TPLINK_BASE_TIME		100					/* Tplink base time tick */

#define TPLINK_INTER_BYTE_TIME	(40/TPLINK_BASE_TIME)		/* Inter Byte timeout in ms */
#define TPLINK_INTER_FRAME_TIME	(150/TPLINK_BASE_TIME) 	/* Inter Frame timeout in ms */
