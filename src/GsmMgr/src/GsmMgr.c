...
RKH_DCLR_CHOICE_STATE GsmMgr_C0, GsmMgr_C1, GsmMgr_C2, GsmMgr_C3, GsmMgr_C4;
...
static void PinToEnableNetTimeExt15(GsmMgr *const me, RKH_EVT_T *pe);
...
static void IdleSMSToSendingSMSExt74(SMS *const me, RKH_EVT_T *pe);
static void ListSMSToC4Ext77(SMS *const me, RKH_EVT_T *pe);
static void SendingSMSToIdleSMSExt79(SMS *const me, RKH_EVT_T *pe);
static void C3ToSMSResetExt81(SMS *const me, RKH_EVT_T *pe);
static void C4ToSendingSMSCmdRespExt83(SMS *const me, RKH_EVT_T *pe);
static void C4ToDeleteSMSExt84(SMS *const me, RKH_EVT_T *pe);
...
static void RegisteredToRegisteredLoc14(GsmMgr *const me, RKH_EVT_T *pe);
static void RegisteredToRegisteredLoc15(GsmMgr *const me, RKH_EVT_T *pe);
static void Socket_GsmReadyToSocket_GsmReadyLoc16(Socket *const me, RKH_EVT_T *pe);
static void Socket_GsmReadyToSocket_GsmReadyLoc17(Socket *const me, RKH_EVT_T *pe);
static void GetStatusToGetStatusLoc26(Socket *const me, RKH_EVT_T *pe);
static void GetStatusToGetStatusLoc27(Socket *const me, RKH_EVT_T *pe);
static void Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc28(Socket *const me, RKH_EVT_T *pe);
static void Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc29(Socket *const me, RKH_EVT_T *pe);
static void SMS_WaitGsmReadyToSMS_WaitGsmReadyLoc30(SMS *const me, RKH_EVT_T *pe);
static void SMS_GsmReadyToSMS_GsmReadyLoc31(SMS *const me, RKH_EVT_T *pe);
...
static void enDeleteSMS(SMS *const me);
...
static rbool_t isCondC3ToSMSReset81(SMS *const me, RKH_EVT_T *pe);
static rbool_t isCondC4ToSendingSMSCmdResp83(SMS *const me, RKH_EVT_T *pe);
...
RKH_CREATE_BASIC_STATE(GsmMgr_Sending, NULL, NULL, &GsmMgr_Connected, NULL);
...
RKH_CREATE_BASIC_STATE(GsmMgr_DeleteSMS, enDeleteSMS, NULL, &GsmMgr_SMS_GsmReady, NULL);
RKH_CREATE_BASIC_STATE(GsmMgr_SendingSMS, NULL, NULL, &GsmMgr_SMS_GsmReady, NULL);
RKH_CREATE_BASIC_STATE(GsmMgr_SendingSMSCmdResp, NULL, NULL, &GsmMgr_SMS_GsmReady, NULL);
RKH_CREATE_BASIC_STATE(GsmMgr_SMSReset, NULL, NULL, &GsmMgr_SMS_GsmReady, NULL);
...
RKH_CREATE_TRANS_TABLE(GsmMgr_Pin)
	...
	RKH_TRREG(evSimReady, NULL, PinToEnableNetTimeExt15, &GsmMgr_EnableNetTime),
RKH_END_TRANS_TABLE
...
RKH_CREATE_TRANS_TABLE(GsmMgr_Registered)
	...
	RKH_TRINT(evNetClockSync, NULL, RegisteredToRegisteredLoc14),
	RKH_TRINT(evLocalTime, NULL, RegisteredToRegisteredLoc15),
RKH_END_TRANS_TABLE
...
RKH_CREATE_TRANS_TABLE(GsmMgr_Socket_GsmReady)
    ...
    RKH_TRINT(evSend, NULL, Socket_GsmReadyToSocket_GsmReadyLoc16),
    RKH_TRINT(evRecv, NULL, Socket_GsmReadyToSocket_GsmReadyLoc17),
RKH_END_TRANS_TABLE
...
RKH_CREATE_TRANS_TABLE(GsmMgr_GetStatus)
    ...
    RKH_TRINT(evSend, NULL, GetStatusToGetStatusLoc26),
    RKH_TRINT(evRecv, NULL, GetStatusToGetStatusLoc27),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_Sending)
    RKH_TRREG(evOk, NULL, SendingToIdleExt64, &GsmMgr_Idle),
    RKH_TRREG(evNoResponse, NULL, SendingToIdleExt65, &GsmMgr_Idle),
    RKH_TRREG(evError, NULL, SendingToIdleExt65, &GsmMgr_Idle),
RKH_END_TRANS_TABLE
...
RKH_CREATE_TRANS_TABLE(GsmMgr_Socket_WaitGsmReady)
    ...
    RKH_TRINT(evRecv, NULL, Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc28),
    RKH_TRINT(evSend, NULL, Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc29),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_SMS_WaitGsmReady)
    RKH_TRREG(evGsmReady, NULL, NULL, &GsmMgr_SMS_GsmReady),
    RKH_TRINT(evSendSMS, NULL, SMS_WaitGsmReadyToSMS_WaitGsmReadyLoc30),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_SMS_GsmReady)
    RKH_TRREG(evGsmError, NULL, NULL, &GsmMgr_SMS_WaitGsmReady),
    RKH_TRINT(evSendSMS, NULL, SMS_GsmReadyToSMS_GsmReadyLoc31),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_IdleSMS)
    RKH_TRREG(evTout8, NULL, NULL, &GsmMgr_ListSMS),
    RKH_TRREG(evSendSMS, NULL, IdleSMSToSendingSMSExt74, &GsmMgr_SendingSMS),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_ListSMS)
    RKH_TRREG(evNoSMS, NULL, NULL, &GsmMgr_IdleSMS),
	RKH_TRREG(evNewSMS, NULL, ListSMSToC4Ext77, &GsmMgr_C4),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_DeleteSMS)
	RKH_TRREG(evDoneSMS, NULL, NULL, &GsmMgr_C3),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_SendingSMS)
    RKH_TRREG(evDoneSMS, NULL, SendingSMSToIdleSMSExt79, &GsmMgr_IdleSMS),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_SendingSMSCmdResp)
	RKH_TRREG(evDoneSMS, NULL, NULL, &GsmMgr_DeleteSMS),
RKH_END_TRANS_TABLE

RKH_CREATE_TRANS_TABLE(GsmMgr_SMSReset)
RKH_END_TRANS_TABLE

RKH_CREATE_CHOICE_STATE(GsmMgr_C0);
RKH_CREATE_CHOICE_STATE(GsmMgr_C1);
RKH_CREATE_CHOICE_STATE(GsmMgr_C2);
RKH_CREATE_CHOICE_STATE(GsmMgr_C3);
RKH_CREATE_CHOICE_STATE(GsmMgr_C4);
...
RKH_CREATE_BRANCH_TABLE(GsmMgr_C3)
	RKH_BRANCH(isCondC3ToSMSReset81, C3ToSMSResetExt81, &GsmMgr_SMSReset),
	RKH_BRANCH(ELSE, NULL, &GsmMgr_IdleSMS),
RKH_END_BRANCH_TABLE

RKH_CREATE_BRANCH_TABLE(GsmMgr_C4)
	RKH_BRANCH(isCondC4ToSendingSMSCmdResp83, C4ToSendingSMSCmdRespExt83, &GsmMgr_SendingSMSCmdResp),
	RKH_BRANCH(ELSE, C4ToDeleteSMSExt84, &GsmMgr_DeleteSMS),
RKH_END_BRANCH_TABLE
...
static RKH_ROM_STATIC_EVENT(e_SendSMSOk, evSendSMSOk);
static RKH_ROM_STATIC_EVENT(e_SendSMSFail, evSendSMSFail);
...
static void
parseSMS(SMS *const me, SMSEvt *pe)
{
    RKH_FWK_RSV(pe);

    me->psms = pe;
    me->yCmdRes = YCommand_parseAndExec(&(me->yCmd), pe->data, pe->size);
}
...
static void
sendCmdResp(SMS *const me, SMSEvt *pe)
{
    int len;
...
static rbool_t 
isSMSCmd(SMS *const me)
{
	return (me->yCmdRes != YCmdUnknown) ? true : false;
}

static rbool_t 
SMSCmdWReset(SMS *const me)
{
	return (me->yCmd.reset == 1) ? true : false;
}
...
ToInactiveExt0(GsmMgr *const me, RKH_EVT_T *pe)
{
	...
	RKH_TR_FWK_STATE(me, &GsmMgr_SendingSMS);
	RKH_TR_FWK_STATE(me, &GsmMgr_SendingSMSCmdResp);
	RKH_TR_FWK_STATE(me, &GsmMgr_SMSReset);
	...
	RKH_TR_FWK_PSTATE(me, &GsmMgr_C3);
	RKH_TR_FWK_PSTATE(me, &GsmMgr_C4);
	...
	RKH_TR_FWK_TIMER(&me->itsSMS.tmEvtObj8.tmr);
		...
		RKH_TR_FWK_OBJ_NAME(PinToEnableNetTimeExt15, "PinToEnableNetTimeExt15");
        ...
        RKH_TR_FWK_OBJ_NAME(IdleSMSToSendingSMSExt74, "IdleSMSToSendingSMSExt74");
        RKH_TR_FWK_OBJ_NAME(ListSMSToC4Ext77, "ListSMSToC4Ext77");
        RKH_TR_FWK_OBJ_NAME(SendingSMSToIdleSMSExt79, "SendingSMSToIdleSMSExt79");
        RKH_TR_FWK_OBJ_NAME(C3ToSMSResetExt81, "C3ToSMSResetExt81");
        RKH_TR_FWK_OBJ_NAME(C4ToSendingSMSCmdRespExt83, "C4ToSendingSMSCmdRespExt83");
        RKH_TR_FWK_OBJ_NAME(C4ToDeleteSMSExt84, "C4ToDeleteSMSExt84");
		...
		RKH_TR_FWK_OBJ_NAME(RegisteredToRegisteredLoc14, "RegisteredToRegisteredLoc14");
		RKH_TR_FWK_OBJ_NAME(RegisteredToRegisteredLoc15, "RegisteredToRegisteredLoc15");
		RKH_TR_FWK_OBJ_NAME(Socket_GsmReadyToSocket_GsmReadyLoc16, "Socket_GsmReadyToSocket_GsmReadyLoc16");
		RKH_TR_FWK_OBJ_NAME(Socket_GsmReadyToSocket_GsmReadyLoc17, "Socket_GsmReadyToSocket_GsmReadyLoc17");
		RKH_TR_FWK_OBJ_NAME(GetStatusToGetStatusLoc26, "GetStatusToGetStatusLoc26");
		RKH_TR_FWK_OBJ_NAME(GetStatusToGetStatusLoc27, "GetStatusToGetStatusLoc27");
		RKH_TR_FWK_OBJ_NAME(Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc28, "Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc28");
		RKH_TR_FWK_OBJ_NAME(Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc29, "Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc29");
		RKH_TR_FWK_OBJ_NAME(SMS_WaitGsmReadyToSMS_WaitGsmReadyLoc30, "SMS_WaitGsmReadyToSMS_WaitGsmReadyLoc30");
		RKH_TR_FWK_OBJ_NAME(SMS_GsmReadyToSMS_GsmReadyLoc31, "SMS_GsmReadyToSMS_GsmReadyLoc31");
		...
		RKH_TR_FWK_OBJ_NAME(enDeleteSMS, "enDeleteSMS");
		...
		RKH_TR_FWK_OBJ_NAME(isCondC3ToSMSReset81, "isCondC3ToSMSReset81");
		RKH_TR_FWK_OBJ_NAME(isCondC4ToSendingSMSCmdResp83, "isCondC4ToSendingSMSCmdResp83");
	#endif
...
static void 
PinToEnableNetTimeExt15(GsmMgr *const me, RKH_EVT_T *pe)
{
	bsp_SIMReady();
}
...
static void 
SendingToIdleExt65(Socket *const me, RKH_EVT_T *pe)
{
	sendFail(me);
}

static void 
ToSocket_WaitGsmReadyExt69(Socket *const me, RKH_EVT_T *pe)
{
...
static void 
IdleSMSToSendingSMSExt74(SMS *const me, RKH_EVT_T *pe)
{
    ModCmd_sendSMS(((SendSMSEvt *)(pe))->dest,
                    ((SendSMSEvt *)(pe))->buf,
                    ((SendSMSEvt *)(pe))->size);
}
...
static void 
SendingSMSToIdleSMSExt79(SMS *const me, RKH_EVT_T *pe)
{
    sendSMSOk(me);
}
...
static void 
C4ToSendingSMSCmdRespExt83(SMS *const me, RKH_EVT_T *pe)
{
	sendCmdResp(me, pe);
}

static void 
C4ToDeleteSMSExt84(SMS *const me, RKH_EVT_T *pe)
{
...
static void 
RegisteredToRegisteredLoc14(GsmMgr *const me, RKH_EVT_T *pe)
{
	ModCmd_getLocalTime();
}

static void 
RegisteredToRegisteredLoc15(GsmMgr *const me, RKH_EVT_T *pe)
{
	rtimeSync(pe);
}

static void 
Socket_GsmReadyToSocket_GsmReadyLoc16(Socket *const me, RKH_EVT_T *pe)
{
    sendFail(me);
}

static void 
Socket_GsmReadyToSocket_GsmReadyLoc17(Socket *const me, RKH_EVT_T *pe)
{
    recvFail(me);
}

static void 
GetStatusToGetStatusLoc26(Socket *const me, RKH_EVT_T *pe)
{
	reqDefer(pe);
}

static void 
GetStatusToGetStatusLoc27(Socket *const me, RKH_EVT_T *pe)
{
	reqDefer(pe);
}

static void 
Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc28(Socket *const me, RKH_EVT_T *pe)
{
    recvFail(me);
}

static void 
Socket_WaitGsmReadyToSocket_WaitGsmReadyLoc29(Socket *const me, RKH_EVT_T *pe)
{
    sendFail(me);
}

static void 
SMS_WaitGsmReadyToSMS_WaitGsmReadyLoc30(SMS *const me, RKH_EVT_T *pe)
{
    sendSMSFail(me);
}

static void 
SMS_GsmReadyToSMS_GsmReadyLoc31(SMS *const me, RKH_EVT_T *pe)
{
    sendSMSFail(me);
}
...
static void 
enDeleteSMS(SMS *const me)
{
    ModCmd_deleteSMS(me->psms->index);
    RKH_FWK_GC(RKH_CAST(RKH_EVT_T, me->psms), me->itsGsmMgr);
}
...
static rbool_t 
isCondC3ToSMSReset81(SMS *const me, RKH_EVT_T *pe)
{
	return (SMSCmdWReset(me)) ? true : false;
}
	
static rbool_t 
isCondC4ToSendingSMSCmdResp83(SMS *const me, RKH_EVT_T *pe)
{
	return (isSMSCmd(me)) ? true : false;
}
