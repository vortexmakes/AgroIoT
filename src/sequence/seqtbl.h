...
typedef struct
{
    ...
    signed char index;              /* Index to following sequence. <0 for one
                                     * shot	*/
} SEQ_T;

typedef struct
{
    void (*phard)(unsigned short minor, MUInt arg0, MUInt arg1);    /*	Hardware
                                                                     * routine			*/
    const SEQ_T     *pseq_t;                            /*	Pointer to sequence
                                                         * table	*/
    unsigned char minors_num;                           /*  Number of minor
                                                         * devices		*/
    unsigned char seqs_num;                             /*	Numer of sequences
                                                         * in major	*/
} MAJOR_T;
