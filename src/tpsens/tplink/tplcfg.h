...
#define TPLINK_ADDRESSING_ON    1       /* 1/0 Enable/Disable Protocol Slaves
                                         * Addressing */
#endif
...
#define TPLINK_BSP_SUPPORT_TC_IRQ   0   /*	On Allmost embedded platforms based
                                         * on MCU we port
                                         *  TPLINK to the lower level hardware
                                         * accesing to MCU registers,
                                         *  in this case, depending of MCU, we
                                         * may obtain an IRQ when
                                         *  Transmition	is Complete (TC).
                                         *  In the other hand, for example in
                                         * Windows Environment,
                                         *  the bsp don't inform to us when the
                                         * transmision is really
                                         *  completed.
                                         *  Then in order to bring a rule to set
                                         * this option,
                                         *  except Windows Platforms, this
                                         * option is set to 1.
                                         */
...
#define TPLINK_INTER_BYTE_TIME  (40 / TPLINK_BASE_TIME)   /* Inter Byte timeout
                                                           * in ms */
#endif
...
#define __USE_TPLINK_ONXMIT_CMP_CBF__   0           /* Enable/Disable transmit
                                                     * complete call back
                                                     * function */
#define __USE_TPLINK_ONCHERR_CBF__      1           /* Enable/Disable check sum
